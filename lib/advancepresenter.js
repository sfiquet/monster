...
exports.get = function getAdvancePage(req, res){
	 ...
	 */
	 function renderNoMonster(){
		res.render('advancement-form', { options: req.params.options, postTo: req.url });
	 }
	...
	*/
	...
	myDB.findMonster(req.params.monster, function(err, stats){
		...
		// format the data for the template
			...
			res.render('advancement-form', { monster: stats.name, options: req.params.options, stats: stats, postTo: req.url});
		}
	});
};
