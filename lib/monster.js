...
function Monster() {
	...
	this.speed = properties.speed || '30 ft.';	// temporary: store a string until we need the value
	this.space = properties.space || 5;
	this.reach = properties.reach || 5;
...
Monster.prototype.getMeleeWeaponDamageBonus = function(attack) {
	return Math.floor(this.getStrMod() * this.getDamageFactor(attack));
